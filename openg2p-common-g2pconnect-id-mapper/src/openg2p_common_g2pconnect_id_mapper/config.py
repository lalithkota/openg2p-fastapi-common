...
class Settings(Settings):
    ...
    mapper_resolve_sender_url: str = "http://localhost:8000/mapper/on-resolve"
    mapper_link_sender_url: str = "http://localhost:8000/mapper/on-link"
    mapper_update_sender_url: str = "http://localhost:8000/mapper/on-update"
