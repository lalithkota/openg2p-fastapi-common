...
[![PyPI](https://img.shields.io/pypi/v/openg2p-ioc-common?label=pypi%20package)](https://pypi.org/project/openg2p-ioc-common)
[![PyPI - Downloads](https://img.shields.io/pypi/dm/openg2p-ioc-common)](https://pypi.org/project/openg2p-ioc-common)

This package contains can be used to form base IOC aspects for other modules, etc.
